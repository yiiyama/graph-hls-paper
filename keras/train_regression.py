...
if __name__ == '__main__':
    ...
    if args.use_generator:
        ...
        train_gen, n_train_steps = make_generator(args.train_path, args.batch_size, format=input_format, features=features, n_vert_max=n_vert_max, y_shape=y_shape, y_dtype=np.float, y_features=y_features, dataset_name=args.input_name)
        ...
        if args.validation_path:
            valid_gen, n_valid_steps = make_generator(args.validation_path, args.batch_size, format=input_format, features=features, n_vert_max=n_vert_max, y_shape=y_shape, y_dtype=np.float, y_features=y_features, dataset_name=args.input_name)
